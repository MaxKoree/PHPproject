...
class database{
    ...
    private function is_admin($username){
        ...
        // check if the user is an admin, is so, return true
    ...
    public function get_user_info($username){
        ...
        // select certain column data from table account and person 
        $sql = "
            SELECT p.first_name, p.middle_name, p.last_name, a.username, a.email 
            FROM person as p 
